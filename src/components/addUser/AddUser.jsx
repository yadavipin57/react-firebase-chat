...
//   const {currentnUser} = useUserStore();
...
//                 chatId: newChatRef.id,
//                 lastMessage: "",
//                 receiverId: currentnUser.id,
//                 updatedAt: Date.now(),
//             })
//         })

//         await updateDoc(doc(userChatsRef, currentnUser.id), {
//             chats: arrayUnion({
//                 chatId: newChatRef.id,
//                 lastMessage: "",
//                 receiverId: user.id,
...
//             <span>{user.username}</span>
//           </div>
//           <button className="px-3 py-1 bg-[#1a73e8] text-white border-none cursor-pointer rounded-lg" onClick={handleAdd}>
//             Add
//           </button>
//         </div>
//       )}
